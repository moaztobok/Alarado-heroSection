...
const navbar = () => {
  ...
  return (
    <nav className='max-container flex justify-between items-center py-5 px-5 overflow-hidden'>
        ...
        <div className='absolute shadow-xl lg:hidden flex flex-col top-0 px-5 py-10 h-screen items-center w-[80%] right-0 text-primary text-[2rem] bg-secondary gap-2  animate-slideIn'
            style={{transform:`translateX(${showMenu ? '0%' : '100%' })` ,display:`${showMenu ? 'flex' : 'none' }`}}>
            <div className='w-full h-10 flex justify-end'>
            <button onClick={handleMenu} className='menu cursor-pointer'>
